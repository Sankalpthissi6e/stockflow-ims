...
const SALE_STATUSES = ['all', 'quotation', 'packing', 'dispatched', 'history'];
...
export default function Sales() {
  ...
  async function openCreate() {
    try {
      const [c, p] = await Promise.all([fetchCustomers(), fetchProducts()]);
      setCustomers(c);
      setProducts(p);
    } catch { /* ignore */ }
    setForm({
  ...
  function selectCustomer(id) {
    ...
    setForm({ ...form, party_id: id, party_name: cust ? cust.name : '' });
  }
